...
public class CountArray {
	...
	return type: int[]
	params: int size 
	in the method, build array and assign values then return it
	 */
	public static int [] getArray() {
		int [] retArray = {2, 5, 98, 56, 34};
	return retArray;
	}
	...
	Return type: int []
	Params: int size 
	int the method create an array with value of size and assign
	 random values from 0-100 and return it.
	*/
