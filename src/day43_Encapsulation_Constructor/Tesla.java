...
public class Tesla {
	...
	/*
	 * return model.equals("model s") || model.equals("model 3") ||
	 * model.equals("model x") || model.equals("model y") ||
	 * model.equals("roadster");
	 * 
	 * switch(model) { case "model s": case "model 3": case "model x": case
	 * "model y": case "roadster": return true; default: return false; }
	 */
}
